...
class UserHabitAdapter(private val habitCertification: List<Certification>, val nickname: String, val habitName: String, val context: Context, private val createdDate: String, private val profileImageUrl: String)
    :RecyclerView.Adapter<UserHabitAdapter.UserHabitViewHolder>() {

    inner class UserHabitViewHolder(binding: ItemHabitUploadBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserHabitViewHolder {
        val binding = ItemHabitUploadBinding.inflate(LayoutInflater.from(parent.context), parent, false)

        return UserHabitViewHolder(binding)
    }

    override fun onBindViewHolder(holder: UserHabitViewHolder, position: Int) {
